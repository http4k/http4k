...
class MetricFiltersServerTest {
    ...
    private val server by lazy {
        ServerFilters.CatchAll().then(ServerFilters.CatchLensFailure).then(routes(
                "/timed" bind routes(
    ...
    @Test
    fun `routes without uri template generate request timing metrics tagged with unmapped path value`() {
