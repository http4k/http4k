...
class MoshiJson(val moshi: com.squareup.moshi.Moshi): Json<MoshiNode> {
    ...
    override fun Int?.asJsonValue() = if (this == null) MoshiNull else MoshiInteger(toBigInteger())
    override fun Double?.asJsonValue() = if (this == null) MoshiNull else MoshiDecimal(toBigDecimal())
    override fun Long?.asJsonValue() = if (this == null) MoshiNull else MoshiInteger(toBigInteger())
    override fun BigDecimal?.asJsonValue() = if (this == null) MoshiNull else MoshiDecimal(this)
    override fun BigInteger?.asJsonValue() = if (this == null) MoshiNull else MoshiInteger(this)
    ...
    override fun decimal(value: MoshiNode) = (value as MoshiDecimal).value
    override fun integer(value: MoshiNode) = ((value as MoshiInteger).value).toLong()
