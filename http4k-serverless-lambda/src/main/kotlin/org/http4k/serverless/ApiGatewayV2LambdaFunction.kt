...
internal object ApiGatewayV2AwsHttpAdapter : AwsHttpAdapter<APIGatewayV2HTTPEvent, APIGatewayV2HTTPResponse> {
    override fun invoke(req: APIGatewayV2HTTPEvent) =
        RequestContent(req.rawPath, req.queryStringParameters, req.rawQueryString, req.body, req.isBase64Encoded, req.requestContext.http.method, req.headers).asHttp4k()
