...
class BasicAuthSecurity private constructor(override val filter: Filter, val name: String = "basicAuth") : Security {
     ...
     */
    constructor(realm: String, credentials: Credentials, name: String = "basicAuth") : this(
        ServerFilters.BasicAuth(
            realm,
            credentials
        ), name
    )

    constructor(realm: String, credentials: (Credentials) -> Boolean) : this(
        ServerFilters.BasicAuth(
            realm,
            credentials
        )
