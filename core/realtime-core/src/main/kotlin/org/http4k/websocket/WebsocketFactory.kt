...
interface WebsocketFactory {
     ...
     */
    suspend fun nonBlocking(uri: Uri, headers: Headers = emptyList(), onError: (Throwable) -> Unit = {}, onConnect: WsConsumer = {}): Websocket
     ...
     */
    suspend fun blocking(uri: Uri, headers: Headers = emptyList()): WsClient
}

suspend fun WebsocketFactory.nonBlocking(uri: String, headers: Headers = emptyList(), onError: (Throwable) -> Unit = {}, onConnect: WsConsumer = {}) =
    nonBlocking(Uri.of(uri), headers, onError, onConnect)

suspend fun WebsocketFactory.blocking(uri: String, headers: Headers = emptyList()) =
