...
```groovy
dependencies {
    compile group: "org.http4k", name: "http4k-core", version: "2.0.4"
    compile group: "org.http4k", name: "http4k-server-jetty", version: "2.0.4"
    compile group: "org.http4k", name: "http4k-client-apache", version: "2.0.4"
}
```
