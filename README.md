...
dependencies {
    ...
    compile group: "org.http4k", name: "http4k-server-jetty", version: "2.25.4"
    compile group: "org.http4k", name: "http4k-client-okhttp", version: "2.25.4"
}
```
...
//    content-length: 9
//    date: Thu, 08 Jun 2.25.43:01:13 GMT
//    expires: 0
//    server: Jetty(9.3.16.v2.25.420)
//
//    hello Bob
}
```
...
Support this project by becoming a sponsor. Your logo will show up here with a link to your website. [[Become a sponsor](https://opencollective.com/http4k#sponsor)]
