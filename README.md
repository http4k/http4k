...
```groovy
dependencies {
    compile group: "org.http4k", name: "http4k-core", version: "1.26.2"
    compile group: "org.http4k", name: "http4k-server-jetty", version: "1.26.2"
    compile group: "org.http4k", name: "http4k-client-apache", version: "1.26.2"
}
```
...
## Core Module
**Gradle:** ```compile group: "org.http4k", name: "http4k-core", version: "1.26.2"```
...
**Gradle (Jetty):** ```compile group: "org.http4k", name: "http4k-server-jetty", version: "1.26.2"```

**Gradle (Netty):** ```compile group: "org.http4k", name: "http4k-server-netty", version: "1.26.2"```

**Gradle (Undertow):** ```compile group: "org.http4k", name: "http4k-server-undertow", version: "1.26.2"```
...
**Gradle (Apache):** ```compile group: "org.http4k", name: "http4k-client-apache", version: "1.26.2"```
**Gradle (OkHttp):** ```compile group: "org.http4k", name: "http4k-client-okhttp", version: "1.26.2"```
...
## Contracts Module
**Gradle:** ```compile group: "org.http4k", name: "http4k-contract", version: "1.26.2"```
...
**Gradle (Argo):**  ```compile group: "org.http4k", name: "http4k-format-argo", version: "1.26.2"```

**Gradle (Gson):**  ```compile group: "org.http4k", name: "http4k-format-gson", version: "1.26.2"```

**Gradle (Jackson):** ```compile group: "org.http4k", name: "http4k-format-jackson", version: "1.26.2"```
...
## Templating Modules
**Gradle:** ```compile group: "org.http4k", name: "http4k-template-handlebars", version: "1.26.2"```
