...
dependencies {
    ...
    compile group: "org.http4k", name: "http4k-server-jetty", version: "2.31.4"
    compile group: "org.http4k", name: "http4k-client-okhttp", version: "2.31.4"
}
```
...
//    content-length: 9
//    date: Thu, 08 Jun 2.31.43:01:13 GMT
//    expires: 0
//    server: Jetty(9.3.16.v2.31.420)
//
//    hello Bob
}
```
