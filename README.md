...
<a href="http://kotlinlang.org"><img alt="kotlin" src="https://img.shields.io/badge/kotlin-1.1.60-blue.svg"></a>
...
* **Modularity:** Common behaviours are abstracted into the `http4k-core` module. Current add-ons cover:
    * Pluggable HTTP client adapters for Apache and OkHttp and Websockets
...
dependencies {
    ...
    compile group: "org.http4k", name: "http4k-server-jetty", version: "3.2.3"
    compile group: "org.http4k", name: "http4k-client-okhttp", version: "3.2.3"
}
```
...
//    content-length: 9
//    date: Thu, 08 Jun 3.2.33:01:13 GMT
//    expires: 0
//    server: Jetty(9.3.16.v3.2.320)
//
//    hello Bob
}
```
