...
<a href="http://kotlinlang.org"><img alt="kotlin" src="https://img.shields.io/badge/kotlin-1.1.50-blue.svg"></a>
...
```groovy
dependencies {
    compile group: "org.http4k", name: "http4k-core", version: "2.37.0"
    compile group: "org.http4k", name: "http4k-server-jetty", version: "2.37.0"
    compile group: "org.http4k", name: "http4k-client-okhttp", version: "2.37.0"
}
```
...
//    content-length: 9
//    date: Thu, 08 Jun 2.37.03:01:13 GMT
//    expires: 0
//    server: Jetty(9.3.16.v2.37.020)
//
//    hello Bob
}
```
