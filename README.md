...
```groovy
dependencies {
    compile group: "org.http4k", name: "http4k-core", version: "1.33.1"
    compile group: "org.http4k", name: "http4k-server-jetty", version: "1.33.1"
    compile group: "org.http4k", name: "http4k-client-apache", version: "1.33.1"
}
```
