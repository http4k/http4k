...
```groovy
dependencies {
    compile group: "org.http4k", name: "http4k-core", version: "1.0.0"
    compile group: "org.http4k", name: "http4k-server-jetty", version: "1.0.0"
    compile group: "org.http4k", name: "http4k-client-apache", version: "1.0.0"
}
```
...
## Core Module
**Gradle:** ```compile group: "org.http4k", name: "http4k-core", version: "1.0.0"```
...
## Server Modules
**Gradle (Jetty):** ```compile group: "org.http4k", name: "http4k-server-jetty", version: "1.0.0"```
...
**Gradle (Argo):**  ```compile group: "org.http4k", name: "http4k-format-argo", version: "1.0.0"```

**Gradle (Gson):**  ```compile group: "org.http4k", name: "http4k-format-gson", version: "1.0.0"```

**Gradle (Jackson):** ```compile group: "org.http4k", name: "http4k-format-jackson", version: "1.0.0"```
