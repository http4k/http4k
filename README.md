...
dependencies {
    ...
    compile group: "org.http4k", name: "http4k-server-jetty", version: "2.29.2"
    compile group: "org.http4k", name: "http4k-client-okhttp", version: "2.29.2"
}
```
...
//    content-length: 9
//    date: Thu, 08 Jun 2.29.23:01:13 GMT
//    expires: 0
//    server: Jetty(9.3.16.v2.29.220)
//
//    hello Bob
}
```
