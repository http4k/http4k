...
```groovy
dependencies {
    compile group: "org.http4k", name: "http4k-core", version: "1.3.0"
    compile group: "org.http4k", name: "http4k-server-jetty", version: "1.3.0"
    compile group: "org.http4k", name: "http4k-client-apache", version: "1.3.0"
}
```
...
## Core Module
**Gradle:** ```compile group: "org.http4k", name: "http4k-core", version: "1.3.0"```
...
## Server Modules
**Gradle (Jetty):** ```compile group: "org.http4k", name: "http4k-server-jetty", version: "1.3.0"```

**Gradle (Netty):** ```compile group: "org.http4k", name: "http4k-server-netty", version: "1.3.0"```
...
## Client Modules
**Gradle:** ```compile group: "org.http4k", name: "http4k-client-apache", version: "1.3.0"```
...
## Contracts Module
**Gradle:** ```compile group: "org.http4k", name: "http4k-contract", version: "1.3.0"```
...
**Gradle (Argo):**  ```compile group: "org.http4k", name: "http4k-format-argo", version: "1.3.0"```

**Gradle (Gson):**  ```compile group: "org.http4k", name: "http4k-format-gson", version: "1.3.0"```

**Gradle (Jackson):** ```compile group: "org.http4k", name: "http4k-format-jackson", version: "1.3.0"```
...
## Templating Modules
**Gradle:** ```compile group: "org.http4k", name: "http4k-template-handlebars", version: "1.3.0"```
