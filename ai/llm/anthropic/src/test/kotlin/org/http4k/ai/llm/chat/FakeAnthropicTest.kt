...
class FakeAnthropicTest : ChatContract, PortBasedTest {
    ...
    private val http = FakeAnthropicAI(completionGenerators = mapOf(AnthropicModels.Claude_Haiku_3_5 to MessageContentGenerator { it ->
        when {
    ...
    override val chat = Chat.AnthropicAI(AnthropicIApiKey.of("asd"), http)
