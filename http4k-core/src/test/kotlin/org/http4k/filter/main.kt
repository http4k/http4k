...
fun main(args: Array<String>) {
    ...
    val requestsFromDisk: Sequence<Request> = Requester.from(Traffic.Stream.DiskQueue())
    val requestsFromMemory: Sequence<Request> = Requester.from(Traffic.Stream.MemoryQueue(mutableListOf()))
