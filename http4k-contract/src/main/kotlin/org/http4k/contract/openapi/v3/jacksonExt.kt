 ...
 */
fun OpenApi3(apiInfo: ApiInfo, extensions: List<OpenApiExtension> = emptyList(), json: Jackson = Jackson) = OpenApi3(apiInfo, json, extensions, ApiRenderer.Auto(json, AutoJsonToJsonSchema(json)))
