...
class PathDef4<out A, out B, out C, out D> internal constructor(pathFn: (BasePath) -> BasePath, val a: PathLens<A>, val b: PathLens<B>, val c: PathLens<C>, val d: PathLens<D>) : PathDef(pathFn, a, b, c, d) {
