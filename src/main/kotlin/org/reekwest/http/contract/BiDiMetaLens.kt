...
abstract class BiDiMetaLens<IN, OUT, FINAL>(meta: Meta, val delegateLens: BiDiLens<IN, OUT>) : MetaLens<IN, OUT, FINAL>(meta, delegateLens.get) {
    ...
    operator fun <R : IN> invoke(value: FINAL, target: R): R = delegateLens.set(convertOut(value), target) as R
