...
Run the single command in the readme of [this repo](https://github.com/http4k/http4k-bootstrap) to create a full CD pipelined HelloWorld app with Github/Travis/Heroku. The script will prompt for auth tokens for each service.
