...
```groovy
// AWS Lambda: 
implementation group: "org.http4k", name: "http4k-serverless-lambda", version: "4.7.0.2"

// Google Cloud Functions: 
implementation group: "org.http4k", name: "http4k-serverless-gcf", version: "4.7.0.2"

// Apache OpenWhisk (IBM Cloud Functions): 
implementation group: "org.http4k", name: "http4k-serverless-openwhisk", version: "4.7.0.2"

// Azure Functions: 
implementation group: "org.http4k", name: "http4k-serverless-azure", version: "4.7.0.2"

// Alibaba Function Compute: 
implementation group: "org.http4k", name: "http4k-serverless-alibaba", version: "4.7.0.2"

// Tencent Serverless Cloud Functions: 
implementation group: "org.http4k", name: "http4k-serverless-tencent", version: "4.7.0.2"
```
