...
```groovy
// AWS Lambda: 
compile group: "org.http4k", name: "http4k-serverless-lambda", version: "3.255.0"

// Google Cloud Functions: 
compile group: "org.http4k", name: "http4k-serverless-gcf", version: "3.255.0"

// Apache OpenWhisk: 
compile group: "org.http4k", name: "http4k-serverless-openwhisk", version: "3.255.0"
```
