...
```groovy
// AWS Lambda: 
implementation group: "org.http4k", name: "http4k-serverless-lambda", version: "3.270.0"
...
implementation group: "org.http4k", name: "http4k-serverless-tencent", version: "3.270.0"
```
