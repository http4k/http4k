...
### Installation (Gradle)
```compile group: "org.http4k", name: "http4k-serverless-lambda", version: "3.112.1"```
...
#### Code [<img class="octocat" src="/img/octocat-32.png"/>](https://github.com/http4k/http4k/blob/master/src/docs/guide/modules/serverless/example_lambda.kt)
