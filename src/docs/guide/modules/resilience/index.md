...
### Installation (Gradle)
```compile group: "org.http4k", name: "http4k-resilience4j", version: "3.1.3"```
...
### Circuit Breaking [<img class="octocat" src="/img/octocat-32.png"/>](https://github.com/http4k/http4k/blob/master/src/ddocs/guide/modules/resilience/example_circuit.kt)
...
### Rate Limiting [<img class="octocat" src="/img/octocat-32.png"/>](https://github.com/http4k/http4k/blob/master/src/ddocs/guide/modules/resilience/example_ratelimiter.kt)
...
### Retrying [<img class="octocat" src="/img/octocat-32.png"/>](https://github.com/http4k/http4k/blob/master/src/ddocs/guide/modules/resilience/example_retrying.kt)
...
### Bulkheading [<img class="octocat" src="/img/octocat-32.png"/>](https://github.com/http4k/http4k/blob/master/src/ddocs/guide/modules/resilience/example_bulkheading.kt)
