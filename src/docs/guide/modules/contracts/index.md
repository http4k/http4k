...
```groovy
implementation group: "org.http4k", name: "http4k-contract", version: "3.270.1"
implementation group: "org.http4k", name: "http4k-format-<insert json lib>", version: "3.270.1"
```
