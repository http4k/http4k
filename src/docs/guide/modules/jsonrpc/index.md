...
### Installation (Gradle)
```compile group: "org.http4k", name: "http4k-jsonrpc", version: "3.109.0"```
...
#### Code [<img class="octocat" src="/img/octocat-32.png"/>](https://github.com/http4k/http4k/blob/master/src/docs/guide/modules/jsonrpc/example.kt)
