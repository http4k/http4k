...
```groovy
implementation group: "org.http4k", name: "http4k-format-argo", version: "3.155.0"
```

**Gson:**

```groovy
implementation group: "org.http4k", name: "http4k-format-gson", version: "3.155.0"
```

**Jackson:**

```groovy
implementation group: "org.http4k", name: "http4k-format-jackson", version: "3.155.0"
```

**Moshi:**

```groovy
implementation group: "org.http4k", name: "http4k-format-moshi", version: "3.155.0"
```
