...
```groovy
// Argo:  
implementation group: "org.http4k", name: "http4k-format-argo", version: "3.275.0"

// Gson:  
implementation group: "org.http4k", name: "http4k-format-gson", version: "3.275.0"

// Jackson: 
implementation group: "org.http4k", name: "http4k-format-jackson", version: "3.275.0"

// Moshi: 
implementation group: "org.http4k", name: "http4k-format-moshi", version: "3.275.0"

// KotlinX Serialization: 
implementation group: "org.http4k", name: "http4k-format-kotlinx-serialization", version: "3.275.0"
```
