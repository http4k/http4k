...
### Installation (Gradle)
**Argo:**  ```compile group: "org.http4k", name: "http4k-format-argo", version: "3.179.1"```

**Gson:**  ```compile group: "org.http4k", name: "http4k-format-gson", version: "3.179.1"```

**Jackson:** ```compile group: "org.http4k", name: "http4k-format-jackson", version: "3.179.1"```

**Moshi:** ```compile group: "org.http4k", name: "http4k-format-moshi", version: "3.179.1"```
