...
### Installation (Gradle)
**Argo:**  ```compile group: "org.http4k", name: "http4k-format-argo", version: "3.158.0"```

**Gson:**  ```compile group: "org.http4k", name: "http4k-format-gson", version: "3.158.0"```

**Jackson:** ```compile group: "org.http4k", name: "http4k-format-jackson", version: "3.158.0"```

**Moshi:** ```compile group: "org.http4k", name: "http4k-format-moshi", version: "3.158.0"```
