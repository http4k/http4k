...
### Installation (Gradle)
**Argo:**  ```compile group: "org.http4k", name: "http4k-format-argo", version: "3.26.5"```

**Gson:**  ```compile group: "org.http4k", name: "http4k-format-gson", version: "3.26.5"```

**Jackson:** ```compile group: "org.http4k", name: "http4k-format-jackson", version: "3.26.5"```

**Moshi:** ```compile group: "org.http4k", name: "http4k-format-moshi", version: "3.26.5"```

**Xml:** ```compile group: "org.http4k", name: "http4k-format-xml", version: "3.26.5"```
