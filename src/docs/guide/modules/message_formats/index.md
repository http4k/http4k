### Installation (Gradle)
**Argo:**  ```compile group: "org.http4k", name: "http4k-format-argo", version: "2.31.2"```

**Gson:**  ```compile group: "org.http4k", name: "http4k-format-gson", version: "2.31.2"```

**Jackson:** ```compile group: "org.http4k", name: "http4k-format-jackson", version: "2.31.2"```

**Xml:** ```compile group: "org.http4k", name: "http4k-format-xml", version: "2.31.2"```
