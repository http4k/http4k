...
### Installation (Gradle)
**Argo:**  ```compile group: "org.http4k", name: "http4k-format-argo", version: "3.13.2"```

**Gson:**  ```compile group: "org.http4k", name: "http4k-format-gson", version: "3.13.2"```

**Jackson:** ```compile group: "org.http4k", name: "http4k-format-jackson", version: "3.13.2"```

**Moshi:** ```compile group: "org.http4k", name: "http4k-format-moshi", version: "3.13.2"```

**Xml:** ```compile group: "org.http4k", name: "http4k-format-xml", version: "3.13.2"```
