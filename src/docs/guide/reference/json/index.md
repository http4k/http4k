...
```groovy
// Argo:  
implementation group: "org.http4k", name: "http4k-format-argo", version: "4.9.1.0"

// Gson:  
implementation group: "org.http4k", name: "http4k-format-gson", version: "4.9.1.0"

// Jackson: 
implementation group: "org.http4k", name: "http4k-format-jackson", version: "4.9.1.0"

// Klaxon: 
implementation group: "org.http4k", name: "http4k-format-klaxon", version: "4.9.1.0"

// Moshi: 
implementation group: "org.http4k", name: "http4k-format-moshi", version: "4.9.1.0"

// KotlinX Serialization: 
implementation group: "org.http4k", name: "http4k-format-kotlinx-serialization", version: "4.9.1.0"
```
...
#### Code [<img class="octocat"/>](https://github.com/http4k/http4k/blob/docs_reorg/src/docs/reference/json/example.kt)

<script src="https://gist-it.appspot.com/https://github.com/http4k/http4k/blob/docs_reorg/src/docs/reference/json/example.kt"></script>
...
#### Code [<img class="octocat"/>](https://github.com/http4k/http4k/blob/docs_reorg/src/docs/reference/json/autoJson.kt)

<script src="https://gist-it.appspot.com/https://github.com/http4k/http4k/blob/docs_reorg/src/docs/reference/json/autoJson.kt"></script>
...
<script src="https://gist-it.appspot.com/https://github.com/http4k/http4k/blob/docs_reorg/src/docs/reference/json/autoJsonResponse.kt"></script>
...
[<img class="octocat"/>](https://github.com/http4k/http4k/blob/docs_reorg/src/docs/reference/json/list_gotcha.kt)

<script src="https://gist-it.appspot.com/https://github.com/http4k/http4k/blob/docs_reorg/src/docs/reference/json/list_gotcha.kt"></script>
