...
```groovy
implementation group: "org.http4k", name: "http4k-security-oauth", version: "4.9.1.0"
```
...
### Example provider [<img class="octocat"/>](https://github.com/http4k/http4k/blob/docs_reorg/src/docs/reference/oauth/example_provider_oauth.kt)

Out of the box, http4k provides implementations for several OAuth providers.

<script src="https://gist-it.appspot.com/https://github.com/http4k/http4k/blob/docs_reorg/src/docs/reference/oauth/example_provider_oauth.kt"></script>
