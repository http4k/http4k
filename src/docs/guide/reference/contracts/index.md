...
```groovy
implementation group: "org.http4k", name: "http4k-contract", version: "4.17.7.0"
implementation group: "org.http4k", name: "http4k-format-<insert json lib>", version: "4.17.7.0"
```
