...
Events using distributed tracing mechanism and a set of `Tracers` to create a tree of what exactly happened during the
test - these events can be anything, but good examples are:
...
And here is an example of the type of visual documentation that is created:

<img src="./trace_diagram.png" alt="trace diagram">
