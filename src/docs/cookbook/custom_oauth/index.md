...
### Gradle setup
```
    compile group: "org.http4k", name: "http4k-core", version: "3.120.0"
    compile group: "org.http4k", name: "http4k-security-oauth", version: "3.120.0"
```
...
### Code [<img class="octocat"/>](https://github.com/http4k/http4k/blob/master/src/docs/cookbook/custom_oauth/example.kt)
