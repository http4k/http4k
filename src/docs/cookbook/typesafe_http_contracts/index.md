...
- OpenApi v3 documentation - Run this example and point a browser [here](http://petstore.swagger.io/?url=http://localhost:8000/context/swagger.json)

### Gradle setup
```
    compile group: "org.http4k", name: "http4k-core", version: "3.141.0"
    compile group: "org.http4k", name: "http4k-contract", version: "3.141.0"
    compile group: "org.http4k", name: "http4k-format-argo", version: "3.141.0"
```
