...
### Gradle setup
```
    compile group: "org.http4k", name: "http4k-core", version: "3.160.0"
    compile group: "org.http4k", name: "http4k-server-jetty", version: "3.160.0"
    compile group: "org.http4k", name: "http4k-client-websocket", version: "3.160.0"
    compile group: "org.http4k", name: "http4k-format-jackson", version: "3.160.0"
```
