...
```
    ...
    compile group: "org.http4k", name: "http4k-server-jetty", version: "3.93.4"
    compile group: "org.http4k", name: "http4k-client-websocket", version: "3.93.4"
    compile group: "org.http4k", name: "http4k-format-jackson", version: "3.93.4"
```
