...
### v3.274.0 (uncut)
- **http4k-core** [Import break]: Changes to Java annotations to make Java access friendlier. `Response.Companion.create()` is now just `Response.create()` (same with request)
