...
- **http4k-ai-mcp-sdk**: [Unlikely Break] Externalised Progress Token so that you need to pass it directly into progress calls. This makes it explicit that callers without progress tokens will not be able to track progress.
