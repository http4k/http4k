...
flowchart TD
    ...
    step3 -.-> action3
    step2 --> step3
    step4["Step 4: Install cosign"]
    style step4 fill:#f8f9fa,stroke:#495057
    action4["🎬 sigstore<br/>cosign-installer"]
    style action4 fill:#e1f5fe,stroke:#0277bd
    step4 -.-> action4
    step3 --> step4
    step5["Step 5: Build artifacts<br/>💻 bash"]
    style step5 fill:#f3e5f5,stroke:#7b1fa2
    step4 --> step5
    step6["Step 6: Generate SBOMs<br/>💻 bash"]
    style step6 fill:#f3e5f5,stroke:#7b1fa2
    step5 --> step6
    step7["Step 7: Generate license reports<br/>💻 bash"]
