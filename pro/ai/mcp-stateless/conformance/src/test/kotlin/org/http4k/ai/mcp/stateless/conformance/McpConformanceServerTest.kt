 ...
 */
package org.http4k.ai.mcp.stateless.conformance

import com.natpryce.hamkrest.assertion.assertThat
import com.natpryce.hamkrest.equalTo
import dev.forkhandles.result4k.valueOrNull
import org.http4k.ai.mcp.stateless.client.http.HttpMcpClient
import org.http4k.ai.mcp.stateless.conformance.server.McpConformanceServer
    ...
    fun `assembles and exposes the conformance tools over the stateless transport`() {
        ...
        assertThat(
            tools, equalTo(
                setOf(
                    "test_simple_text",
                    "test_custom_header", "test_image_content", "test_audio_content", "test_embedded_resource",
