 ...
 */
package org.http4k.ai.mcp.stateless.x402
...
import org.http4k.ai.mcp.stateless.x402.PaymentCheck.Free
import org.http4k.ai.mcp.stateless.x402.PaymentCheck.Required
import org.http4k.ai.mcp.stateless.x402.SettlementMode.SettleAfter
import org.http4k.ai.mcp.stateless.x402.SettlementMode.SettleBefore
...
private fun settleBefore(
    ...
    next: (ToolRequest) -> org.http4k.ai.mcp.stateless.ToolResponse,
    request: ToolRequest,
