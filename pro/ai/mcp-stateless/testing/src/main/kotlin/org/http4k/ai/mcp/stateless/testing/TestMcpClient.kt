 ...
 */
package org.http4k.ai.mcp.stateless.testing
 ...
 */
fun HttpHandler.testMcpClient(
    baseUri: Uri = Uri.of("http://mcp/mcp"),
    capabilities: ClientCapabilities = ClientCapabilities(ElicitationForm, ElicitationUrl)
): McpClient = HttpMcpClient(baseUri, http = this, capabilities = capabilities)
