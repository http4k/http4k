...
// Uri drops an empty authority, so file:///x would mirror as file:/x. An empty host with an absolute
// path is the empty-authority case; with a relative path (urn:isbn:1) there is genuinely no authority.
