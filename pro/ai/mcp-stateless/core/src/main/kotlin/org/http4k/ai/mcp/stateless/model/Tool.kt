...
import org.http4k.ai.mcp.stateless.model.ToolArgLensSpec.Companion.mapWithNewMeta
...
class Tool private constructor(
    ...
    constructor(
        ...
        meta: Meta? = null
    ) : this(ToolName.of(name), description, arguments.toList(), output, title, annotations, icons, meta)
