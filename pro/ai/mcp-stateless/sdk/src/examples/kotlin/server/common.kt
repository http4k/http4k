...
fun LinksOnPage(http: HttpHandler): ResourceHandler = {
    val htmlPage = http(org.http4k.core.Request(GET, Uri.of(it.uri.value)))
...
fun staticResource() =
    Resource.Static(McpUri.of("https://www.http4k.org"), ResourceName.of("HTTP4K"), "description") bind LinksOnPage(
        JavaHttpClient()
    )
