...
fun NonStreamingMcpConnection(
    ...
    Method.POST.asRouter() bind { req -> mcpProtocol.receive(req).asHttp(mcpProtocol.serverInfo) },
    orElse bind { Response.Companion(Status.METHOD_NOT_ALLOWED).with(Header.ALLOW of listOf(Method.POST)) }
)
