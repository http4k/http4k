...
import org.http4k.mcp.model.ElicitationTest.FooBar.BAR
import org.http4k.mcp.model.ElicitationTest.FooBar.FOO
...
class ElicitationTest {
    ...
    class Foo private constructor(value: LocalDate) : LocalDateValue(value) {
        companion object : LocalDateValueFactory<Foo>(::Foo)
    }
