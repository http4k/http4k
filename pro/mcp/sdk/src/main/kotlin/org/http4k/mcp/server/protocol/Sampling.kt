 ...
 */
interface Sampling {
    fun receive(id: MessageId, response: McpSampling.Response): CompletionStatus
    fun sampleClient(
        entity: McpEntity,
    ...
    fun onSampleClient(sessionId: SessionId, entity: McpEntity, fn: (McpSampling.Request, MessageId) -> Unit)
