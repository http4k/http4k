...
class RemoteMcpTransport<Sink>(
...
) : McpTransport<Response, Sink>, Startable {
    ...
    override fun verify(sessionId: SessionId, request: Request) = sessionProvider.verify(sessionId, request)
