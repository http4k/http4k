...
import org.http4k.wiretap.mcp.completions.Completions
...
fun InboundClient(mcpClient: McpClient) = object : WiretapFunction {
    ...
    override fun http(elements: DatastarElementRenderer, html: TemplateRenderer): RoutingHttpHandler {
        ...
        val functions = listOf(Tools(mcpClient), Prompts(mcpClient), Resources(mcpClient), Completions(mcpClient), Apps(mcpApps))
