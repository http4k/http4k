...
import org.http4k.security.signature.SignHttpRequest
...
import org.http4k.security.signature.VerifyHttpSignature
...
fun main() {
    ...
    val server = ServerFilters.VerifyHttpSignature(
        keyResolver = { id -> keyPair.public },
        algorithm = RsaPssSha512,
        requiredComponents = CUSTOM_COMPONENTS
    ).then { request ->
        Response(OK)
