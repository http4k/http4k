...
class Property(val name: String, val type: ClassName, vararg val modifiers: KModifier) {
    constructor(name: String, vararg modifiers: KModifier) : this(ClassName.bestGuess(name).simpleName.decapitalize(), ClassName.bestGuess(name), *modifiers)
