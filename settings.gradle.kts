...
//connect
include(":http4k-connect:tools")

//include(":http4k-connect:http4k-connect-ksp-generator")
...
fun includeWithName(projectName: String, file: String) {
    include(":http4k-connect:$projectName")
    project(":http4k-connect:$projectName").projectDir = File("http4k-connect/$file")
}
